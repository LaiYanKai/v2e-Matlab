...
% 
% %%%%%%%%%%%%%%%%%%%%%%%%%%%% USER PARAMETERS %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% inputPath = "data/faucet_dark.mp4";
% outputPath = "data/faucet_dark_src.mp4"; % output must be avi to support custom colormaps
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%% USER PARAMETERS %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
inputH5Path = "data/faucet_dark_v2e.h5";
outputPath = "data/faucet_dark_v2e.mp4"; % output must be avi to support custom colormaps
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%% USER PARAMETERS %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
inputPath = "data/faucet_dark_src.mp4";
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%% USER PARAMETERS %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
outputPath = "data/faucet_dark_ca.mp4"; % leave blank to stop export of colored video
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%% USER PARAMETERS %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
inputH5Path = "data/faucet_dark_v2e_clean.h5";
outputPath = "data/faucet_dark_v2e_clean.mp4"; % output must be avi to support custom colormaps
outputFrameDuration = 0; % put 0 to use all events (avoids aliasing from rounding errors in this value)
outputContrast = 1; % increase contrast to see more clearly. (1) is default.
outputColormap = eventVideoColormap; % color the event video. See next next section for info
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
% make sure previous section was run
%%%%%%%%%%%%%%%%%%%%%%%%%%%% USER PARAMETERS %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
outputPath = "data/faucet_dark_ca_clean.mp4"; % leave blank to stop export of colored video
outputFrameDuration = 0; 
%     5
%     0 % put 0 to use all events (avoids aliasing from rounding errors in this value)
outputContrast = 5; % adjust the grayscale video to make events easier to see
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%% USER PARAMETERS %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
outputPath = "data/faucet_dark_comb.mp4";
inputSrcPath = "data/faucet_dark_src.mp4";
inputV2EPath = "data/faucet_dark_v2e.mp4";
inputCAPath = "data/faucet_dark_ca.mp4";
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%% USER PARAMETERS %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
outputPath = "data/faucet_dark_comb_clean.mp4";
inputSrcPath = "data/faucet_dark_src.mp4";
inputV2EPath = "data/faucet_dark_v2e_clean.mp4";
inputCAPath = "data/faucet_dark_ca_clean.mp4";
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
